...
public class Calendar_main {
	...
	public static void main(String[] args) {
	   ...
	   */   
	   ...
	   int month = currentDate.get(Calendar.MONTH); // 0 ~ 11 (0:1월임)
	      
	   String strMonth = month<10?"0"+month:String.valueOf(month);
	   /* 
         주의해야할 것은 get(Calendar.MONTH)로 얻어오는 ★값의 범위가 1~12가 아닌, 0~11★ 이라는 것이다. 
         그래서 get(Calendar.MONTH)로 얻어오는 ★값이 0이면 1월을 의미하고 11이면 12월★을 의미한다.
	   ...
	   */
	   ...
	   System.out.println("이 해의 몇 째 주: " + currentDate.get(Calendar.WEEK_OF_YEAR));	//52
	   System.out.println("이 달의 몇 째 주: " + currentDate.get(Calendar.WEEK_OF_MONTH));	//4
	    ...
	    System.out.println("이 달의 몇 일: " + strDay);	//20
	    System.out.println("이 해의 몇 일: " + currentDate.get(Calendar.DAY_OF_YEAR));  //354 (일째)
	    
	    // 1:일요일, 2:월요일, 3:화요일, 4:수요일, 5:목요일, 6:금요일, 7:토요일
	    System.out.println("요일(1~7, 1:일요일): " + currentDate.get(Calendar.DAY_OF_WEEK)); //2 (월요일)
	    ...
	    System.out.println("시간(0~11): " + currentDate.get(Calendar.HOUR));			// 12시간 체제
	    System.out.println("시간(0~23): " + currentDate.get(Calendar.HOUR_OF_DAY));	// 24시간 체제
