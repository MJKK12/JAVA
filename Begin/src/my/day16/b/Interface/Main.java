...
public class Main {
	...
	public static void main(String[] args) {
	  ...
	  // == 다형성(Polymorphism) == //
      // ==> 자식클래스로 생성된 객체를 부모클래스의 타입으로 받을 수 있다.
      // ==> ★★★★★ (암기) 특정한 인터페이스로 구현된 클래스의 객체를 특정한 인터페이스의 타입으로 받을 수 있다. ★★★★★
		
	//	Figure fg = new Figure; // 오류!!		
		Figure fg1 = new Rectangle(); // 하나하나 만들어서 figure에 넣을 수 있다.
		...
		// 반지름 4인 원의 넓이 => 50.265472
		
		System.out.println("\n~~~~~~~~~~~~~~~~~~~~~~~~~~\n");
		
		Figure[] fgArr = new Figure[3];
		fgArr[0] = fg1;	// new Rectangle();
		fgArr[1] = fg2;	// new Triangle();
		fgArr[2] = fg3;	// new Circle();

		for(Figure fg : fgArr) {	//확장 for문
